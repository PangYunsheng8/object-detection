...
def build(argscope_fn, box_predictor_config, is_training, num_classes):
  ...
  if box_predictor_oneof == 'sin_box_predictor':
    sin_box_predictor = box_predictor_config.sin_box_predictor
    fc_hyperparams = argscope_fn(sin_box_predictor.fc_hyperparams,
                                 is_training)
    box_predictor_object = box_predictor.SINBoxPredictor(
        is_training=is_training,
        num_classes=num_classes,
        fc_hyperparams=fc_hyperparams,
        use_dropout=sin_box_predictor.use_dropout,
        dropout_keep_prob=sin_box_predictor.dropout_keep_probability,
        box_code_size=sin_box_predictor.box_code_size)
    return box_predictor_object
