...
from object_detection.protos import sin_pb2 as object__detection_dot_protos_dot_sin__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto2',
  serialized_pb=_b('\n#object_detection/protos/model.proto\x12\x17object_detection.protos\x1a)object_detection/protos/faster_rcnn.proto\x1a!object_detection/protos/ssd.proto\x1a!object_detection/protos/sin.proto\"\xaf\x01\n\x0e\x44\x65tectionModel\x12:\n\x0b\x66\x61ster_rcnn\x18\x01 \x01(\x0b\x32#.object_detection.protos.FasterRcnnH\x00\x12+\n\x03ssd\x18\x02 \x01(\x0b\x32\x1c.object_detection.protos.SsdH\x00\x12+\n\x03sin\x18\x03 \x01(\x0b\x32\x1c.object_detection.protos.SINH\x00\x42\x07\n\x05model')
  ,
  dependencies=[object__detection_dot_protos_dot_faster__rcnn__pb2.DESCRIPTOR,object__detection_dot_protos_dot_ssd__pb2.DESCRIPTOR,object__detection_dot_protos_dot_sin__pb2.DESCRIPTOR,])
...
_DETECTIONMODEL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sin', full_name='object_detection.protos.DetectionModel.sin', index=2,
...
_DETECTIONMODEL.fields_by_name['sin'].message_type = object__detection_dot_protos_dot_sin__pb2._SIN
...
_DETECTIONMODEL.oneofs_by_name['model'].fields.append(
  _DETECTIONMODEL.fields_by_name['sin'])
_DETECTIONMODEL.fields_by_name['sin'].containing_oneof = _DETECTIONMODEL.oneofs_by_name['model']
