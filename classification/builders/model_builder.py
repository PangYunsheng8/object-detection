"""Builder for classification models."""
...
from classification.nets import alexnet
from classification.nets import cifarnet
from classification.nets import inception
from classification.nets import lenet
from classification.nets import mobilenet_v1
from classification.nets import overfeat
from classification.nets import resnet_v1
from classification.nets import resnet_v2
from classification.nets import vgg
from classification.nets.mobilenet import mobilenet_v2
from classification.nets.nasnet import nasnet
from classification.nets.nasnet import pnasnet

slim = tf.contrib.slim

def build(spec_config, is_training, weight_decay=0.0):
    """build network function based on the spec config.
...
def _get_network_fn(name, num_classes, weight_decay=0.0, is_training=False):
