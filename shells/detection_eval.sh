...
if [[ -z $1 || -z $2 ]]; then
    echo "Usage:"
    echo "bash detection_eval.sh task_name config_path"
...
python ${DETECTION_DIR}/object_detection/eval.py \
  --logtostderr \
  --checkpoint_dir=/home/store-1-img/Logdir/train/${TASK_NAME} \
  --eval_dir=/home/store-1-img/Logdir/eval/${TASK_NAME} \
